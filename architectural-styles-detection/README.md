...
<img src="images/predict.jpg" width="500px"/>
...
## Оглавление
- [Классификация архитектурных стилей](#классификация-архитектурных-стилей)
  - [Оглавление](#оглавление)
  - [0. Описание проекта](#0-описание-проекта)
  - [1. Исходные данные](#1-исходные-данные)
    - [1.1. Предобученная ML-модель](#11-предобученная-ml-модель)
    - [1.2. Дополнительный датасет](#12-дополнительный-датасет)
  - [2. Подготовка датасета и его аннотация](#2-подготовка-датасета-и-его-аннотация)
  - [3. Обучение ML-модели](#3-обучение-ml-модели)
      - [Графы обучения по эпохам:](#графы-обучения-по-эпохам)
  - [4. Проверка работы модели](#4-проверка-работы-модели)
    - [4.1. Через Roboflow](#41-через-roboflow)
    - [4.2. Через телеграм-бота](#42-через-телеграм-бота)
    - [4.3. Код обращения к API модели, встроенный в веб-сайт](#43-код-обращения-к-api-модели-встроенный-в-веб-сайт)
      - [*К примеру, здание в Готическом стиле модель определила безошибочно:*](#к-примеру-здание-в-готическом-стиле-модель-определила-безошибочно)
    - [4.4. Реализация в Python](#44-реализация-в-python)
  - [5. Дообучение модели через Roboflow](#5-дообучение-модели-через-roboflow)
  - [6. Обучение и fine-tuning модели через YOLOv5](#6-обучение-и-fine-tuning-модели-через-yolov5)
  - [7. Способы повышения точности работы модели](#7-способы-повышения-точности-работы-модели)
  - [8. Векторы развития проекта](#8-векторы-развития-проекта)
___
...
3. Улучшение данных для обучения модели: очистка и группировка профессиональным архитектором.
4. Гибкий ответ системы. Когда в ответ пользователю возвращается не 1, а Топ-3 или Топ-5 наиболее вероятных стилей с указанием вероятности каждого. Это нивелирует ошибку модели в том числе при смешении разных стилей.
...
<img src="images/validation_accuracy.jpg" width="200px"/>

#### Графы обучения по эпохам:

<img src="images/training_graphs.jpg" width="900px"/>
...
<img src="images/roboflow_predict.jpg" width="900px"/>
...
<img src="images/tg_bot.jpg" width="500px"/>
...
<img src="images/web-interface.jpg" width="900px"/>
...
<img src="images/gotic_predict.jpg" width="500px"/>
...
display(df)
```
<img src="images/top5_table.jpg" width="300px"/>
...
## 6. Обучение и fine-tuning модели через YOLOv5
...
3. **Неизвестные архитектурные стили и некорректные фото.**
    ...
    <img src="images/not_architecture.jpg" width="500px"/>
