...
<img src="images/validation_accuracy.jpg" max-width="200px"/>

#### Графы обучения по эпохам:

<img src="images/training_graphs.jpg" max-width="900px"/>
...
<img src="images/roboflow_predict.jpg" max-width="900px"/>
...
<img src="images/tg_bot.jpg" max-width="500px"/>
...
<img src="images/web-interface.jpg" max-width="900px"/>
...
3. **Неизвестные архитектурные стили и некорректные фото.**
    ...
    <img src="images/not_architecture.jpg" max-width="500px"/>
...
<img src="images/top5_table.jpg" max-width="300px"/>
<img src="images/top-5_accuracy.jpg" max-width="900px"/>

1. **Повышение предсказательной точности.** Привлечь архитектора для выверки датасета в целях повышения качества обучения модели и уменьшения мусора в данных.
